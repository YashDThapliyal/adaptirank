...
.PHONY: setup lint typecheck test smoke ci lock official-sample esci-benchmark esci-large \
	...
	import-m3-ce-outputs validate-m3-ce-notebook rank-m3-ce-analysis
...
import-m3-ce-outputs:
	$(UV) run python scripts/import_m3_ce_outputs.py

validate-m3-ce-notebook:
	$(UV) run python scripts/validate_m3_ce_notebook.py

rank-m3-ce-analysis:
	$(UV) run python scripts/analyze_m3_ce_findings.py
